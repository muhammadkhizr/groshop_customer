// ignore_for_file: unnecessary_statements, unused_element
...
import 'package:gromartconsumer/ui/fullScreenImageViewer/fullscreenimage.dart';
...
class _ReviewScreenState extends State<ReviewScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppGlobal.buildSimpleAppBar(context, "addReview".tr()),
                              ...
                              child: Column(children: [
                                ...
                                Container(
                                    ...
                                    child: Text(widget.order.products.first.name,
                                        style: TextStyle(
                                            color: isDarkMode(context) ? Color(0XFFFDFEFE) : Color(0XFF000003), fontFamily: 'Poppinsm', fontSize: 20))),
                                SizedBox(
                                  height: 15,
                                ),
                                RatingBar.builder(
                      ...
                      InkWell(
                        ...
                        child: Card(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                Container(padding: EdgeInsets.only(top: 20), width: 100, child: Image(image: AssetImage('assets/images/add_img.png'))),
                                SizedBox(
                                  height: 10,
                                ),
                                Text("addImages".tr(), style: TextStyle(color: Color(0XFF666666), fontFamily: 'Poppinsr', fontSize: 16))
                              ],
                            ),
                          ),
                        ),
                        ...
                        child: Container(
                            ...
                            child: Column(children: [
                              ...
                              Container(
                                  ...
                                  child: Text(widget.order.products.first.name,
                                      style:
                                          TextStyle(color: isDarkMode(context) ? Color(0XFFFDFEFE) : Color(0XFF000003), fontFamily: 'Poppinsm', fontSize: 20))),
                              SizedBox(
                                height: 15,
                              ),
                              RatingBar.builder(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (imagesToUpload.isNotEmpty) {
                      updateProgress(
                        'uploadingImagesOf'.tr(args: ['1', '${imagesToUpload.length}']),
                      );
                      for (int i = 0; i < imagesToUpload.length; i++) {
                        if (i != 0)
                          updateProgress(
                            'uploadingReviewImagesOf'.tr(
                    ...
                    await updateProgress("reviewUpdateSuccessful".tr());
                    await hideProgress();
  ...
  savereview() async {
    if (_mediaFiles.isEmpty || comment.text == '' || ratings == 0) {
      showAlertDialog(context, 'pleaseAddAllField'.tr(), 'AllFieldReqired'.tr(), true);
    } else if (_formKey.currentState?.validate() ?? false) {
      _formKey.currentState!.save();
      await showProgress(context, 'savingDataToDatabase'.tr(), false);
      List<String> mediaFilesURLs = _mediaFiles.where((element) => element is String).toList().cast<String>();
      List<File> imagesToUpload = _mediaFiles.where((element) => element is File).toList().cast<File>();
      if (imagesToUpload.isNotEmpty) {
        updateProgress(
