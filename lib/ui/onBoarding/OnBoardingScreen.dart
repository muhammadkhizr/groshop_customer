...
class _OnBoardingScreenState extends State<OnBoardingScreen> {
  ...
  final List<String> _subtitlesList = [
    ...
    'findPerfectStoreNearbyOrPlaceOrderAtYourFavoriteStoreInFewClicks'.tr(),
    'aDiverseListOfDifferentDiningStoresThroughoutTheTerritoryAndAroundYourAreaCarefullySelected'.tr(),
    'getYourFavoriteItemFastestDeliveredAtYourDoorstep'.tr(),
  ];
            ...
            child: Positioned(
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: ElevatedButton(
                    style:
                        ElevatedButton.styleFrom(shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(6)), backgroundColor: Color(COLOR_PRIMARY)),
                    child: Text(
                      "Next".tr().toUpperCase(),
