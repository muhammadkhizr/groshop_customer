...
class _MapViewScreenState extends State<MapViewScreen> {
  ...
  void setCustomMaker() async {
    ...
    mapMarkerSelect = await BitmapDescriptor.fromAssetImage(ImageConfiguration(), 'assets/images/map_selected3x.png');
  }
                            ...
                            itemBuilder: (context, index) {
                              return Padding(
                                ...
                                child: GestureDetector(
                                  onTap: () => push(
                                    context,
                                    VendorProductsScreen(vendorModel: vendors[index]),
                                  ),
                                  child: Card(
                                    elevation: 3,
