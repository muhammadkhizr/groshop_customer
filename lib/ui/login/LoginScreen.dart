...
import 'package:gromartconsumer/ui/resetPasswordScreen/ResetPasswordScreen.dart';
...
class _LoginScreen extends State<LoginScreen> {
  ...
  _loginWithEmailAndPassword(String email, String password) async {
    ...
    if (result != null && result is User && result.role == USER_ROLE_CUSTOMER) {
      ...
      showAlertDialog(context, 'couldntAuthenticate'.tr(), 'loginFailedPleaseTryAgain'.tr(), true);
    }
  }
