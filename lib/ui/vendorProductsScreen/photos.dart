...
import 'package:gromartconsumer/ui/fullScreenImageViewer/FullScreenImageViewer.dart';
          ...
          child: Container(
              ...
              child: FutureBuilder<VendorModel>(
                ...
                builder: (context, snapshot) {
                  ...
                  else if (snapshot.data!.photos.isEmpty) return Center(child: showEmptyState("", 'noImagesAreAvailable'.tr()));
...
class StoreMenuPhoto extends StatefulWidget {
  final List<dynamic> storeMenuPhotos;

  const StoreMenuPhoto({Key? key, required this.storeMenuPhotos}) : super(key: key);
        ...
        child: Container(
          ...
          child: GridView.count(
            ...
            children: List.generate(
              widget.storeMenuPhotos.length,
              (index) {
                return Container(
                  child: InkWell(
                    onTap: () {
                      push(context, FullScreenImageViewer(imageUrl: widget.storeMenuPhotos[index]));
                    },
                    child: Card(
                      color: Color(0xffE7EAED),
                      elevation: 0.5,
                      ...
                      child: CachedNetworkImage(
                        height: 70,
                        width: 100,
                        imageUrl: getImageVAlidUrl(widget.storeMenuPhotos[index]),
                        imageBuilder: (context, imageProvider) => Container(
                          width: 70,
                          height: 100,
