// ignore_for_file: non_constant_identifier_names, unnecessary_null_comparison, unnecessary_brace_in_string_interps, unused_local_variable, unnecessary_type_check, unused_field, unnecessary_statements
...
import 'package:gromartconsumer/ui/vendorProductsScreen/photos.dart';
import 'package:gromartconsumer/ui/vendorProductsScreen/review.dart';
...
class _VendorProductsScreenState extends State<VendorProductsScreen> with TickerProviderStateMixin {
              ...
              child: Column(
                ...
                children: [
                  Stack(children: [
                    Container(
                        ...
                        decoration: BoxDecoration(
                          boxShadow: <BoxShadow>[
                            BoxShadow(color: isDarkMode(context) ? Colors.black38 : Colors.white38, blurRadius: 25.0, offset: Offset(0.0, 0.75))
                          ],
                        ),
                        width: _width * 1,
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [
                    Container(
                        ...
                        child: Text(widget.vendorModel.title,
                            maxLines: 2,
                            style: TextStyle(
                                fontFamily: "Poppinsm", fontSize: 20, letterSpacing: 0.5, color: isDarkMode(context) ? Color(0xffFFFFFF) : Color(0xff2A2A2A)))),
                    resttiming()
                  ]),
                  // SizedBox(height: 10,),
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [
                            ...
                            children: [
                              Column(children: [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                      fontFamily: "Poppinssr", letterSpacing: 0.5, color: isDarkMode(context) ? Colors.grey.shade300 : Color(0xff565764)),
                                ).tr()
                              ]),
                              Column(children: [
                                Image(
                  ...
                  vendorCateoryModel.length == 0
                      ? showEmptyState("", 'noItemAreAvailable'.tr())
                      : Container(
                                        ...
                                        ListView.builder(
                                          ...
                                          itemBuilder: (context, inx) {
                                            return snapshot.data![inx].categoryID == vendorCateoryModel[index].id && snapshot.data![inx].publish == true
                                                ? buildRow(
                                                    snapshot.data![inx], veg, nonveg, snapshot.data![inx].categoryID, (inx == (snapshot.data!.length - 1)))
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          ...
                          style:
                              TextStyle(color: isDarkMode(context) ? Colors.white60 : Color(GREY_TEXT_COLOR), fontWeight: FontWeight.bold, letterSpacing: 0.7),
                        ),
                      ),
                    ],
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text("valid till".tr() + " " + getDate(snapshot.data![index].expireOfferDate!.toDate().toString())!,
                          style: TextStyle(fontFamily: "Poppins", letterSpacing: 0.5, color: isDarkMode(context) ? Colors.white60 : Color(0Xff696A75)))
                    ],
                  ),
                ],
              )),
  ...
  buildRow(ProductModel productModel, veg, nonveg, inx, bool index) {
    ...
    if (vegSwitch == true && productModel.veg == true) {
      ...
      cate++;
      return (isAnother == 0 && index) ? showEmptyState("", 'noItemAreAvailable'.tr()) : Container();
    }
    // else Center();
  }
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text(
                      productModel.name,
                      style:
                          TextStyle(fontSize: 16, fontFamily: "Poppinssb", letterSpacing: 0.5, color: isDarkMode(context) ? Colors.white70 : Color(0XFF2A2A2A)),
                    ),
                    Text(
                      productModel.description,
                      maxLines: 1,
                      style:
                          TextStyle(color: isDarkMode(context) ? Colors.white54 : Color(0xff9091A4), fontFamily: "Poppinsm", letterSpacing: 0.5, fontSize: 15),
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
  ...
  addtocard(productModel, quantity) async {
    ...
    print("product model quantitu " + productModel.name.toString());
            ...
            children: <Widget>[
              Container(
                ...
                Container(
                    ...
                    child: Text(
                      'storeTiming'.tr(),
                      style: TextStyle(fontSize: 18, fontFamily: "Poppinsm", color: isDarkMode(context) ? Color(0XFFdadada) : Color(0XFF252525)),
                    )),
              ])),
              SizedBox(
                height: 10,
                        ...
                        child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text("openTime".tr(),
                                    style: TextStyle(fontSize: 18, fontFamily: "Poppinsr", color: isDarkMode(context) ? Color(0XFFa5a292) : Color(0xff5A5D6D))),
                                //  SizedBox(height: 5,),
                                Text(widget.vendorModel.opentime == '' ? "10:00 AM" : widget.vendorModel.opentime.toString(),
                                    style: TextStyle(fontSize: 18, fontFamily: "Poppinsm", color: isDarkMode(context) ? Color(0XFFa5a292) : Color(0XFF5A5D6D)))
                              ],
                            )),
                      ),
                      SizedBox(
