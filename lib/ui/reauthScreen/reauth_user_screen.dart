          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  'pleaseReAuthenticateInOrderToPerformThisAction'.tr(),
    ...
    return FutureBuilder<bool>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || (snapshot.data != true)) {
          return Center(child: Text('appleSignInIsNoAavailableOnThisDevice'.tr()));
        } else {
