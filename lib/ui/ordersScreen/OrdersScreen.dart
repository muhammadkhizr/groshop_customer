...
import 'package:gromartconsumer/ui/orderDetailsScreen/OrderDetailsScreen.dart';
import 'package:gromartconsumer/ui/reviewScreen.dart/reviewScreen.dart';
      ...
      body: StreamBuilder<List<OrderModel>>(
          ...
          builder: (context, snapshot) {
            ...
            if (!snapshot.hasData || (snapshot.data?.isEmpty ?? true)) {
              return Center(
                child: showEmptyState('noPreviousOrders'.tr(), 'letsOrdersItem'.tr()),
              );
            } else {
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                      ...
                                      children: [
                                        Text(
                                          ...
                                          style: TextStyle(
                                              fontSize: 18, color: isDarkMode(context) ? Colors.grey.shade200 : Color(0XFF000000), fontFamily: "Poppinsm"),
                                        ),
                                        SizedBox(
                                          height: 5,
                                        ),
                                        Row(
                                          children: [
                                            Text(orderModel.status.tr(),
                                                style:
                                                    TextStyle(color: isDarkMode(context) ? Colors.grey.shade200 : Color(0XFF555353), fontFamily: "Poppinsr")),
                                            SizedBox(width: 3),
                                            Image(
                  ...
                  children: [
                    ...
                    InkWell(
                      child: Container(
                          ...
                          child: Text(
                            'reOrder'.tr(),
                            style: TextStyle(color: isDarkMode(context) ? Color(0xffFFFFFF) : Color(DARK_COLOR), fontFamily: "Poppinsm", fontSize: 15
                    ...
                    InkWell(
                      child: Container(
                          ...
                          // primary: Colors.white,
                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(5), border: Border.all(width: 0.8, color: Color(0XFF82807F))),
                          child: Text(
                            'rateOrder'.tr(),
                            style: TextStyle(color: isDarkMode(context) ? Color(0xffFFFFFF) : Color(DARK_COLOR), fontFamily: "Poppinsm", fontSize: 15),
                          )),
