// ignore_for_file: implementation_imports, unnecessary_null_comparison, unused_local_variable
...
class _ViewAllPopularStoreScreenState extends State<ViewAllPopularStoreScreen> {
      ...
      vendorsFuture!.listen((value) {
        if (value != null) {
          ...
          for (int a = 0; a < storeAllLst.length; a++) {
            print(storeAllLst[a].reviewsSum / storeAllLst[a].reviewsCount);
            if ((storeAllLst[a].reviewsSum / storeAllLst[a].reviewsCount) >= 4.0) {
              print(storeAllLst[a].reviewsSum / storeAllLst[a].reviewsCount);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppGlobal.buildAppBar(context, "mostPopular".tr()),
        body: Container(
            ...
            child: showLoader
                ...
                : popularStoreLst.length == 0
                    ? showEmptyState('noItems'.tr(), 'startByAddingVendorsToFirebase'.tr())
                    : ListView.builder(
                        shrinkWrap: true,
