                          ...
                          builder: (context, snapshot) {
                            ...
                            if (!snapshot.hasData || (snapshot.data?.isEmpty ?? true)) {
                              return Container(
                                ...
                                child: showEmptyState('noCoupons'.tr(), 'allYourCouponsWillShowUpHere'.tr()),
                              );
                            } else {
            ...
            child: Stack(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    "${offerModel.discountTypeOffer == "Fix Price" ? "$symbol" : ""}${offerModel.discountOffer}${offerModel.discountTypeOffer == "Percentage" ? "%Off".tr() : "Off".tr()}",
