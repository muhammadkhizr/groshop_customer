// ignore_for_file: unnecessary_null_comparison, unnecessary_type_check, non_constant_identifier_names, unused_local_variable
...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  void initState() {
    super.initState();
    bigImageUrl = (widget.productModel.photo != null && widget.productModel.photo.isNotEmpty) ? widget.productModel.photo : placeholderImage;
    ...
    if (widget.productModel.size.length != 0) {
      for (int a = 0; a < widget.productModel.size.length; a++) {
        AddSizeDemo addSizeDemo =
            AddSizeDemo(name: widget.productModel.size[a], index: a, categoryID: widget.productModel.id, price: widget.productModel.sizePrice[a].toString());
    ...
    return Container(
        ...
        child: Column(children: [
          InkWell(
              ...
              child: Container(
                height: 40,
                decoration: BoxDecoration(border: Border.all(color: Colors.white, width: 0.3), color: Color(0xff000000), shape: BoxShape.circle),
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(fontFamily: "Poppinsm", fontSize: 22, color: isDarkMode(context) ? Color(0xffffffff) : Color(0xff000000)),
                                  ),
                                ),
                                  ...
                                  Padding(
                                    ...
                                    child: /*Text(
                                        ...
                                        widget.productModel.disPrice == "" || widget.productModel.disPrice == "0"
                                            ...
                                            : Text(
                                                symbol + '${double.parse(widget.productModel.disPrice!).toDouble().toStringAsFixed(decimal)}',
                                                style: TextStyle(fontSize: 22, fontFamily: "Poppinssm", color: Color(COLOR_PRIMARY)),
                                              ),
                                  ),
                                  Padding(
                                ...
                                Padding(
                                    ...
                                    child: Text(
                                      ...
                                      style:
                                          TextStyle(fontSize: 16, fontFamily: "Poppinsl", color: isDarkMode(context) ? Color(0xffC6C4C4) : Color(0xff5E5C5C)),
                                    )),
                                SizedBox(height: 10),
                                // Container(
                                //     padding: EdgeInsets.only(right: 20, l
                                //     eft: 20, top: 16),
                                    ...
                                    children: [
                                      lstAddSizeCustom.length == 0
                                          ...
                                          : Text(
                                              "customisation".tr(),
                                              style: TextStyle(
                                                  fontFamily: "Poppinsm", fontSize: 16, color: isDarkMode(context) ? Color(0xffffffff) : Color(0xff000000)),
                                            ),
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        mainAxisAlignment: MainAxisAlignment.start,
                                              ...
                                              children: lstAddSizeCustom
                                                  .map((data) => RadioListTile(
                                                        title: Text(
                                                          ...
                                                          style: TextStyle(fontWeight: FontWeight.bold, fontFamily: "Poppinssm", color: Color(COLOR_PRIMARY)),
                                                        ),
                                                        secondary: Text(
                                                          "${data.name}",
                                                          style: TextStyle(
                                                              fontFamily: "Poppinsl", color: isDarkMode(context) ? Color(0xffC6C4C4) : Color(0xff5E5C5C)),
                                                        ),
                                                ...
                                                child: Row(
                                                  children: [
                                                    Text(
                                                      ...
                                                      style:
                                                          TextStyle(fontFamily: "Poppinsl", color: isDarkMode(context) ? Color(0xffC6C4C4) : Color(0xff5E5C5C)),
                                                    ),
                ...
                child: Row(
                  ...
                  children: [
                    Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                      Text(
                        "itemTotal".tr() + " " + "$symbol" + priceTemp.toString(),
    ...
    if (cartProducts.where((element) => element.vendorID != widget.productModel.vendorID).isEmpty) {
      ...
      await showDialog(
        ...
        builder: (BuildContext context) => ShowDialogToDismiss(
          title: 'vendorConflict'.tr(),
          content: 'doYouWantToRemoveAllTheOtherItemsFromTheCartAndAddThisProductOnly'.tr(),
          buttonText: 'no'.tr(),
  ...
  void getAddOnsData() async {
    ...
    final String addsize = prefs.getString('addsize') != null ? prefs.getString('addsize')! : "";
    ...
    if (lstTemp.length == 0) {
      ...
      for (int d = 0; d < lstTemp.length; d++) {
        if (lstTemp[d].categoryID == widget.productModel.id) {
          AddAddonsDemo addAddonsDemo =
              AddAddonsDemo(name: lstTemp[d].name, index: lstTemp[d].index, isCheck: true, categoryID: lstTemp[d].categoryID, price: lstTemp[d].price);
      ...
      for (int a = 0; a < widget.productModel.addOnsTitle.length; a++) {
        ...
        if (isAddonSelected) {
          AddAddonsDemo addAddonsDemo = AddAddonsDemo(
              name: widget.productModel.addOnsTitle[a], index: a, isCheck: true, categoryID: widget.productModel.id, price: widget.productModel.addOnsPrice[a]);
          lstAddAddonsCustom.add(addAddonsDemo);
        } else {
          AddAddonsDemo addAddonsDemo = AddAddonsDemo(
              name: widget.productModel.addOnsTitle[a],
...
class AddAddonsDemo {
  ...
  factory AddAddonsDemo.fromJson(Map<String, dynamic> jsonData) {
    return AddAddonsDemo(
        index: jsonData['index'], name: jsonData['name'], price: jsonData['price'], isCheck: jsonData['isCheck'], categoryID: jsonData["categoryID"]);
  }
...
class AddSizeDemo {
  ...
  static List<AddSizeDemo> decode(String musics) => (json.decode(musics) as List<dynamic>).map<AddSizeDemo>((item) => AddSizeDemo.fromJson(item)).toList();
